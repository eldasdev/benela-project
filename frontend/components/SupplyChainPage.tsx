...
export default function SupplyChainPage() {
  ...
  return (
    <div style={{ padding: "24px", maxWidth: "1260px", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", gap: "4px", marginBottom: "12px", background: "var(--bg-surface)", border: "1px solid var(--border-default)", borderRadius: "10px", padding: "4px", width: "fit-content" }}>
        <button onClick={() => setTab("items")} style={{ padding: "8px 14px", borderRadius: "8px", border: "none", cursor: "pointer", background: tab === "items" ? "var(--bg-elevated)" : "transparent", color: tab === "items" ? "var(--text-primary)" : "var(--text-subtle)", fontSize: "13px", fontWeight: 600 }}>Inventory Items</button>
        <button onClick={() => setTab("shipments")} style={{ padding: "8px 14px", borderRadius: "8px", border: "none", cursor: "pointer", background: tab === "shipments" ? "var(--bg-elevated)" : "transparent", color: tab === "shipments" ? "var(--text-primary)" : "var(--text-subtle)", fontSize: "13px", fontWeight: 600 }}>Shipments</button>
      </div>
      ...
      {tab === "items" ? (
        <div style={{ background: "var(--bg-surface)", border: "1px solid var(--border-default)", borderRadius: "14px", overflow: "hidden" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: "1px solid var(--border-default)" }}>
            ...
            <button onClick={openItemAdd} style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "8px 14px", borderRadius: "9px", border: "none", background: "var(--accent)", color: "white", fontSize: "13px", fontWeight: 600, cursor: "pointer" }}><Plus size={14} />Add Item</button>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "0.9fr 1.5fr 1fr 0.8fr 0.8fr 0.8fr 0.8fr 92px", gap: "10px", padding: "10px 18px", borderBottom: "1px solid var(--border-soft)", background: "var(--bg-panel)" }}>
          ...
          {items.map((row, idx) => (
            <div key={row.id} style={{ display: "grid", gridTemplateColumns: "0.9fr 1.5fr 1fr 0.8fr 0.8fr 0.8fr 0.8fr 92px", gap: "10px", padding: "12px 18px", borderBottom: idx < items.length - 1 ? "1px solid var(--table-row-divider)" : "none", alignItems: "center" }}>
        ...
        <div style={{ background: "var(--bg-surface)", border: "1px solid var(--border-default)", borderRadius: "14px", overflow: "hidden" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 20px", borderBottom: "1px solid var(--border-default)" }}>
            ...
            <button onClick={openShipmentAdd} style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "8px 14px", borderRadius: "9px", border: "none", background: "var(--accent)", color: "white", fontSize: "13px", fontWeight: 600, cursor: "pointer" }}><Plus size={14} />Add Shipment</button>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "0.9fr 0.8fr 0.8fr 1fr 1fr 0.8fr 0.8fr 92px", gap: "10px", padding: "10px 18px", borderBottom: "1px solid var(--border-soft)", background: "var(--bg-panel)" }}>
          ...
          {shipments.map((row, idx) => (
            <div key={row.id} style={{ display: "grid", gridTemplateColumns: "0.9fr 0.8fr 0.8fr 1fr 1fr 0.8fr 0.8fr 92px", gap: "10px", padding: "12px 18px", borderBottom: idx < shipments.length - 1 ? "1px solid var(--table-row-divider)" : "none", alignItems: "center" }}>
      ...
      {modal ? (
        <div style={{ position: "fixed", inset: 0, background: "var(--overlay-backdrop)", zIndex: 120, display: "flex", alignItems: "center", justifyContent: "center", padding: "18px" }} onClick={() => setModal(null)}>
          <div style={{ width: "760px", maxWidth: "95vw", background: "var(--bg-surface)", border: "1px solid var(--border-default)", borderRadius: "16px", padding: "24px", maxHeight: "90vh", overflow: "auto" }} onClick={(e) => e.stopPropagation()}>
            ...
            {(modal === "add_item" || modal === "edit_item") ? (
              <div style={{ display: "grid", gap: "12px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: "8px" }}>
                  ...
                  <button onClick={() => void saveItem()} disabled={loading} style={{ padding: "8px 14px", borderRadius: "9px", border: "none", background: "var(--accent)", color: "white", fontWeight: 600, cursor: "pointer" }}>{loading ? "Saving..." : "Save Item"}</button>
                </div>
              </div>
            ) : (
              <div style={{ display: "grid", gap: "12px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: "8px" }}>
                  <button onClick={() => setModal(null)} style={{ padding: "8px 14px", borderRadius: "9px", border: "1px solid var(--border-default)", background: "var(--bg-elevated)", color: "var(--text-muted)", cursor: "pointer" }}>Cancel</button>
                  <button onClick={() => void saveShipment()} disabled={loading} style={{ padding: "8px 14px", borderRadius: "9px", border: "none", background: "var(--accent)", color: "white", fontWeight: 600, cursor: "pointer" }}>{loading ? "Saving..." : "Save Shipment"}</button>
                </div>
              </div>
            )}
          </div>
