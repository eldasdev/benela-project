        ...
        {NAV.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span style={{ fontSize: "16px", lineHeight: 1, width: "20px", textAlign: "center" }}>{item.icon}</span>
              <span style={{ fontSize: "13px", fontWeight: isActive ? 500 : 400, color: isActive ? "#e0e0e0" : "#4a4a4a" }}>{item.label}</span>
            </button>
          );
        })}
      </nav>
      <div style={{ padding: "12px", borderTop: "1px solid #1c1c1c" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px", padding: "10px 12px", borderRadius: "10px", background: "#0f0f0f", border: "1px solid #1c1c1c" }}>
